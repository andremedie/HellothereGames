...
function choseQ(number){
	$.ajax({url: "model.php?chose="+number, success: function(result){
...
function startQ(number){
	$.ajax({url: "model.php?start_question="+number, success: function(result){
...
function closeQuestion(number){
	$.ajax({url: "model.php?close="+number, success: function(result){
...
function updateCurrentContent(number){
	...
	if(time == questionTime*1000){
		...
		$.ajax({url: "model.php?get_info="+number, success: function(result){
			$("#control_current_q").html(result);
